...
# Kysytään käyttäjältä arvottavien pisteiden määrän.
N = int(input('Lisää arvottavien pisteiden määrä: '))
n = 0

# Selvitetään ympyrän sisälle osuvien pisteiden määrä for loopilla ja tarkistetaan yhtälöllä,
# että piste on ympyrän sisällä. Jos yhtälö toteutuu niin nostetaan ympyrän pisteiden määrää(n) yhdellä
for _ in range(N):
