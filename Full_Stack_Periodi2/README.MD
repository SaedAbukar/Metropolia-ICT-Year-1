...
Tämä peli on jatkumo ensimäisen periodin pelistä, joka toteuttiin pythonissa. Peliä pelattiin pythonin terminaalissa. Tässä pelissä tehtiin käyttöliittymä pelille. Peli kommunikoi taustapalvelun (pythonin) kanssa flaskin avulla. Python vuorostaan kommunikoi sql tietokannan kanssa.
Backend kansiosta löytyy pythonin ja sql koodit.
Frontend kansiosta löytyy html, css ja javascript koodit.
